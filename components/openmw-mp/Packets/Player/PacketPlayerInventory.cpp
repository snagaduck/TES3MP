...
PacketPlayerInventory::PacketPlayerInventory(mwmp::NetworkManager *network) : PlayerPacket(network)
{
    packetID = ID_PLAYER_INVENTORY;
}

void PacketPlayerInventory::Packet(mwmp::NetBuffer *newBitstream, bool send)
{
