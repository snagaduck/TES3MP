...
PacketPlayerEquipment::PacketPlayerEquipment(mwmp::NetworkManager *network) : PlayerPacket(network)
{
    packetID = ID_PLAYER_EQUIPMENT;
}

void PacketPlayerEquipment::Packet(mwmp::NetBuffer *newBitstream, bool send)
{
