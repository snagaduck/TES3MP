...
PacketPlayerFaction::PacketPlayerFaction(mwmp::NetworkManager *network) : PlayerPacket(network)
{
    packetID = ID_PLAYER_FACTION;
}

void PacketPlayerFaction::Packet(mwmp::NetBuffer *newBitstream, bool send)
{
