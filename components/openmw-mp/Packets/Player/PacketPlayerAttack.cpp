...
PacketPlayerAttack::PacketPlayerAttack(mwmp::NetworkManager *network) : PlayerPacket(network)
{
    packetID = ID_PLAYER_ATTACK;
}

void PacketPlayerAttack::Packet(mwmp::NetBuffer *newBitstream, bool send)
{
