...
#define OBJECTAPI(t) \
    t.set_function("ReadReceivedObjectList", &ObjectFunctions::ReadReceivedObjectList);\
    \
    t.set_function("ClearObjectList", &ObjectFunctions::ClearObjectList);\
    t.set_function("SetObjectListPid", &ObjectFunctions::SetObjectListPid);\
    \
    t.set_function("CopyReceivedObjectListToStore", &ObjectFunctions::CopyReceivedObjectListToStore);\
    \
    t.set_function("GetObjectListSize", &ObjectFunctions::GetObjectListSize);\
    t.set_function("GetObjectListOrigin", &ObjectFunctions::GetObjectListOrigin);\
    t.set_function("GetObjectListClientScript", &ObjectFunctions::GetObjectListClientScript);\
    t.set_function("GetObjectListAction", &ObjectFunctions::GetObjectListAction);\
    t.set_function("GetObjectListConsoleCommand", &ObjectFunctions::GetObjectListConsoleCommand);\
    t.set_function("GetObjectListContainerSubAction", &ObjectFunctions::GetObjectListContainerSubAction);\
    \
    t.set_function("IsObjectPlayer", &ObjectFunctions::IsObjectPlayer);\
    t.set_function("GetObjectPid", &ObjectFunctions::GetObjectPid);\
    t.set_function("GetObjectRefId", &ObjectFunctions::GetObjectRefId);\
    t.set_function("GetObjectRefNum", &ObjectFunctions::GetObjectRefNum);\
    t.set_function("GetObjectMpNum", &ObjectFunctions::GetObjectMpNum);\
    t.set_function("GetObjectCount", &ObjectFunctions::GetObjectCount);\
    t.set_function("GetObjectCharge", &ObjectFunctions::GetObjectCharge);\
    t.set_function("GetObjectEnchantmentCharge", &ObjectFunctions::GetObjectEnchantmentCharge);\
    t.set_function("GetObjectSoul", &ObjectFunctions::GetObjectSoul);\
    t.set_function("GetObjectGoldValue", &ObjectFunctions::GetObjectGoldValue);\
    t.set_function("GetObjectScale", &ObjectFunctions::GetObjectScale);\
    t.set_function("GetObjectSoundId", &ObjectFunctions::GetObjectSoundId);\
    t.set_function("GetObjectState", &ObjectFunctions::GetObjectState);\
    t.set_function("GetObjectDoorState", &ObjectFunctions::GetObjectDoorState);\
    t.set_function("GetObjectLockLevel", &ObjectFunctions::GetObjectLockLevel);\
    t.set_function("GetObjectDialogueChoiceType", &ObjectFunctions::GetObjectDialogueChoiceType);\
    t.set_function("GetObjectDialogueChoiceTopic", &ObjectFunctions::GetObjectDialogueChoiceTopic);\
    t.set_function("GetObjectGoldPool", &ObjectFunctions::GetObjectGoldPool);\
    t.set_function("GetObjectLastGoldRestockHour", &ObjectFunctions::GetObjectLastGoldRestockHour);\
    t.set_function("GetObjectLastGoldRestockDay", &ObjectFunctions::GetObjectLastGoldRestockDay);\
    \
    t.set_function("DoesObjectHavePlayerActivating", &ObjectFunctions::DoesObjectHavePlayerActivating);\
    t.set_function("GetObjectActivatingPid", &ObjectFunctions::GetObjectActivatingPid);\
    t.set_function("GetObjectActivatingRefId", &ObjectFunctions::GetObjectActivatingRefId);\
    t.set_function("GetObjectActivatingRefNum", &ObjectFunctions::GetObjectActivatingRefNum);\
    t.set_function("GetObjectActivatingMpNum", &ObjectFunctions::GetObjectActivatingMpNum);\
    t.set_function("GetObjectActivatingName", &ObjectFunctions::GetObjectActivatingName);\
    \
    t.set_function("GetObjectHitSuccess", &ObjectFunctions::GetObjectHitSuccess);\
    t.set_function("GetObjectHitDamage", &ObjectFunctions::GetObjectHitDamage);\
    t.set_function("GetObjectHitBlock", &ObjectFunctions::GetObjectHitBlock);\
    t.set_function("GetObjectHitKnockdown", &ObjectFunctions::GetObjectHitKnockdown);\
    t.set_function("DoesObjectHavePlayerHitting", &ObjectFunctions::DoesObjectHavePlayerHitting);\
    t.set_function("GetObjectHittingPid", &ObjectFunctions::GetObjectHittingPid);\
    t.set_function("GetObjectHittingRefId", &ObjectFunctions::GetObjectHittingRefId);\
    t.set_function("GetObjectHittingRefNum", &ObjectFunctions::GetObjectHittingRefNum);\
    t.set_function("GetObjectHittingMpNum", &ObjectFunctions::GetObjectHittingMpNum);\
    t.set_function("GetObjectHittingName", &ObjectFunctions::GetObjectHittingName);\
    \
    t.set_function("GetObjectSummonState", &ObjectFunctions::GetObjectSummonState);\
    t.set_function("GetObjectSummonEffectId", &ObjectFunctions::GetObjectSummonEffectId);\
    t.set_function("GetObjectSummonSpellId", &ObjectFunctions::GetObjectSummonSpellId);\
    t.set_function("GetObjectSummonDuration", &ObjectFunctions::GetObjectSummonDuration);\
    t.set_function("DoesObjectHavePlayerSummoner", &ObjectFunctions::DoesObjectHavePlayerSummoner);\
    t.set_function("GetObjectSummonerPid", &ObjectFunctions::GetObjectSummonerPid);\
    t.set_function("GetObjectSummonerRefId", &ObjectFunctions::GetObjectSummonerRefId);\
    t.set_function("GetObjectSummonerRefNum", &ObjectFunctions::GetObjectSummonerRefNum);\
    t.set_function("GetObjectSummonerMpNum", &ObjectFunctions::GetObjectSummonerMpNum);\
    \
    t.set_function("GetObjectPosX", &ObjectFunctions::GetObjectPosX);\
    t.set_function("GetObjectPosY", &ObjectFunctions::GetObjectPosY);\
    t.set_function("GetObjectPosZ", &ObjectFunctions::GetObjectPosZ);\
    t.set_function("GetObjectRotX", &ObjectFunctions::GetObjectRotX);\
    t.set_function("GetObjectRotY", &ObjectFunctions::GetObjectRotY);\
    t.set_function("GetObjectRotZ", &ObjectFunctions::GetObjectRotZ);\
    \
    t.set_function("GetVideoFilename", &ObjectFunctions::GetVideoFilename);\
    \
    t.set_function("GetClientLocalsSize", &ObjectFunctions::GetClientLocalsSize);\
    t.set_function("GetClientLocalInternalIndex", &ObjectFunctions::GetClientLocalInternalIndex);\
    t.set_function("GetClientLocalVariableType", &ObjectFunctions::GetClientLocalVariableType);\
    t.set_function("GetClientLocalIntValue", &ObjectFunctions::GetClientLocalIntValue);\
    t.set_function("GetClientLocalFloatValue", &ObjectFunctions::GetClientLocalFloatValue);\
    \
    t.set_function("GetContainerChangesSize", &ObjectFunctions::GetContainerChangesSize);\
    t.set_function("GetContainerItemRefId", &ObjectFunctions::GetContainerItemRefId);\
    t.set_function("GetContainerItemCount", &ObjectFunctions::GetContainerItemCount);\
    t.set_function("GetContainerItemCharge", &ObjectFunctions::GetContainerItemCharge);\
    t.set_function("GetContainerItemEnchantmentCharge", &ObjectFunctions::GetContainerItemEnchantmentCharge);\
    t.set_function("GetContainerItemSoul", &ObjectFunctions::GetContainerItemSoul);\
    t.set_function("GetContainerItemActionCount", &ObjectFunctions::GetContainerItemActionCount);\
    \
    t.set_function("DoesObjectHaveContainer", &ObjectFunctions::DoesObjectHaveContainer);\
    t.set_function("IsObjectDroppedByPlayer", &ObjectFunctions::IsObjectDroppedByPlayer);\
    \
    t.set_function("SetObjectListCell", &ObjectFunctions::SetObjectListCell);\
    t.set_function("SetObjectListAction", &ObjectFunctions::SetObjectListAction);\
    t.set_function("SetObjectListContainerSubAction", &ObjectFunctions::SetObjectListContainerSubAction);\
    t.set_function("SetObjectListConsoleCommand", &ObjectFunctions::SetObjectListConsoleCommand);\
    \
    t.set_function("SetObjectRefId", &ObjectFunctions::SetObjectRefId);\
    t.set_function("SetObjectRefNum", &ObjectFunctions::SetObjectRefNum);\
    t.set_function("SetObjectMpNum", &ObjectFunctions::SetObjectMpNum);\
    t.set_function("SetObjectCount", &ObjectFunctions::SetObjectCount);\
    t.set_function("SetObjectCharge", &ObjectFunctions::SetObjectCharge);\
    t.set_function("SetObjectEnchantmentCharge", &ObjectFunctions::SetObjectEnchantmentCharge);\
    t.set_function("SetObjectSoul", &ObjectFunctions::SetObjectSoul);\
    t.set_function("SetObjectGoldValue", &ObjectFunctions::SetObjectGoldValue);\
    t.set_function("SetObjectScale", &ObjectFunctions::SetObjectScale);\
    t.set_function("SetObjectState", &ObjectFunctions::SetObjectState);\
    t.set_function("SetObjectLockLevel", &ObjectFunctions::SetObjectLockLevel);\
    t.set_function("SetObjectDialogueChoiceType", &ObjectFunctions::SetObjectDialogueChoiceType);\
    t.set_function("SetObjectDialogueChoiceTopic", &ObjectFunctions::SetObjectDialogueChoiceTopic);\
    t.set_function("SetObjectGoldPool", &ObjectFunctions::SetObjectGoldPool);\
    t.set_function("SetObjectLastGoldRestockHour", &ObjectFunctions::SetObjectLastGoldRestockHour);\
    t.set_function("SetObjectLastGoldRestockDay", &ObjectFunctions::SetObjectLastGoldRestockDay);\
    t.set_function("SetObjectDisarmState", &ObjectFunctions::SetObjectDisarmState);\
    t.set_function("SetObjectDroppedByPlayerState", &ObjectFunctions::SetObjectDroppedByPlayerState);\
    t.set_function("SetObjectPosition", &ObjectFunctions::SetObjectPosition);\
    t.set_function("SetObjectRotation", &ObjectFunctions::SetObjectRotation);\
    t.set_function("SetObjectSound", &ObjectFunctions::SetObjectSound);\
    \
    t.set_function("SetObjectSummonState", &ObjectFunctions::SetObjectSummonState);\
    t.set_function("SetObjectSummonEffectId", &ObjectFunctions::SetObjectSummonEffectId);\
    t.set_function("SetObjectSummonSpellId", &ObjectFunctions::SetObjectSummonSpellId);\
    t.set_function("SetObjectSummonDuration", &ObjectFunctions::SetObjectSummonDuration);\
    t.set_function("SetObjectSummonerPid", &ObjectFunctions::SetObjectSummonerPid);\
    t.set_function("SetObjectSummonerRefNum", &ObjectFunctions::SetObjectSummonerRefNum);\
    t.set_function("SetObjectSummonerMpNum", &ObjectFunctions::SetObjectSummonerMpNum);\
    \
    t.set_function("SetObjectActivatingPid", &ObjectFunctions::SetObjectActivatingPid);\
    \
    t.set_function("SetObjectDoorState", &ObjectFunctions::SetObjectDoorState);\
    t.set_function("SetObjectDoorTeleportState", &ObjectFunctions::SetObjectDoorTeleportState);\
    t.set_function("SetObjectDoorDestinationCell", &ObjectFunctions::SetObjectDoorDestinationCell);\
    t.set_function("SetObjectDoorDestinationPosition", &ObjectFunctions::SetObjectDoorDestinationPosition);\
    t.set_function("SetObjectDoorDestinationRotation", &ObjectFunctions::SetObjectDoorDestinationRotation);\
    \
    t.set_function("SetPlayerAsObject", &ObjectFunctions::SetPlayerAsObject);\
    \
    t.set_function("SetContainerItemRefId", &ObjectFunctions::SetContainerItemRefId);\
    t.set_function("SetContainerItemCount", &ObjectFunctions::SetContainerItemCount);\
    t.set_function("SetContainerItemCharge", &ObjectFunctions::SetContainerItemCharge);\
    t.set_function("SetContainerItemEnchantmentCharge", &ObjectFunctions::SetContainerItemEnchantmentCharge);\
    t.set_function("SetContainerItemSoul", &ObjectFunctions::SetContainerItemSoul);\
    \
    t.set_function("SetContainerItemActionCountByIndex", &ObjectFunctions::SetContainerItemActionCountByIndex);\
    \
    t.set_function("AddObject", &ObjectFunctions::AddObject);\
    t.set_function("AddClientLocalInteger", &ObjectFunctions::AddClientLocalInteger);\
    t.set_function("AddClientLocalFloat", &ObjectFunctions::AddClientLocalFloat);\
    t.set_function("AddContainerItem", &ObjectFunctions::AddContainerItem);\
    \
    t.set_function("SendObjectActivate", &ObjectFunctions::SendObjectActivate);\
    t.set_function("SendObjectPlace", &ObjectFunctions::SendObjectPlace);\
    t.set_function("SendObjectSpawn", &ObjectFunctions::SendObjectSpawn);\
    t.set_function("SendObjectDelete", &ObjectFunctions::SendObjectDelete);\
    t.set_function("SendObjectLock", &ObjectFunctions::SendObjectLock);\
    t.set_function("SendObjectDialogueChoice", &ObjectFunctions::SendObjectDialogueChoice);\
    t.set_function("SendObjectMiscellaneous", &ObjectFunctions::SendObjectMiscellaneous);\
    t.set_function("SendObjectRestock", &ObjectFunctions::SendObjectRestock);\
    t.set_function("SendObjectTrap", &ObjectFunctions::SendObjectTrap);\
    t.set_function("SendObjectScale", &ObjectFunctions::SendObjectScale);\
    t.set_function("SendObjectSound", &ObjectFunctions::SendObjectSound);\
    t.set_function("SendObjectState", &ObjectFunctions::SendObjectState);\
    t.set_function("SendObjectMove", &ObjectFunctions::SendObjectMove);\
    t.set_function("SendObjectRotate", &ObjectFunctions::SendObjectRotate);\
    t.set_function("SendDoorState", &ObjectFunctions::SendDoorState);\
    t.set_function("SendDoorDestination", &ObjectFunctions::SendDoorDestination);\
    t.set_function("SendContainer", &ObjectFunctions::SendContainer);\
    t.set_function("SendVideoPlay", &ObjectFunctions::SendVideoPlay);\
    t.set_function("SendClientScriptLocal", &ObjectFunctions::SendClientScriptLocal);\
    t.set_function("SendConsoleCommand", &ObjectFunctions::SendConsoleCommand);\
    \
    t.set_function("ReadLastObjectList", &ObjectFunctions::ReadLastObjectList);\
    t.set_function("ReadLastEvent", &ObjectFunctions::ReadLastEvent);\
    t.set_function("InitializeObjectList", &ObjectFunctions::InitializeObjectList);\
    t.set_function("InitializeEvent", &ObjectFunctions::InitializeEvent);\
    t.set_function("CopyLastObjectListToStore", &ObjectFunctions::CopyLastObjectListToStore);\
    t.set_function("GetObjectChangesSize", &ObjectFunctions::GetObjectChangesSize);\
    t.set_function("GetEventAction", &ObjectFunctions::GetEventAction);\
    t.set_function("GetEventContainerSubAction", &ObjectFunctions::GetEventContainerSubAction);\
    t.set_function("GetObjectRefNumIndex", &ObjectFunctions::GetObjectRefNumIndex);\
    t.set_function("GetObjectSummonerRefNumIndex", &ObjectFunctions::GetObjectSummonerRefNumIndex);\
    t.set_function("SetEventCell", &ObjectFunctions::SetEventCell);\
    t.set_function("SetEventAction", &ObjectFunctions::SetEventAction);\
    t.set_function("SetEventConsoleCommand", &ObjectFunctions::SetEventConsoleCommand);\
    t.set_function("SetObjectRefNumIndex", &ObjectFunctions::SetObjectRefNumIndex);\
    t.set_function("AddWorldObject", &ObjectFunctions::AddWorldObject);
